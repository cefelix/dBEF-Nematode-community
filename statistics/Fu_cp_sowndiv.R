...
m.Fu2_sowndiv_p <- brm(
  bf(Fu2 ~ sowndivLogStd*treatment*week + (1|block/plot),
     hu ~ 1),
  data = dat, 
...
m.Fu2_sowndiv_p2 <- update(m.Fu2_sowndiv_p,
                           bf(Fu2 ~ sowndivLogStd*treatment + sowndivLogStd*week + treatment*week + 
                              ...
                              hu ~ 1 ),
                           seed=SEED)
m.Fu2_sowndiv_p2 %>% pp_check(ndraws=100)

m.Fu2_sowndiv_p31 <- update(m.Fu2_sowndiv_p,
                            bf(Fu2 ~ sowndivLogStd*treatment + treatment*week + 
                                 (1|block/plot),
                               hu ~ 1 ),
                            seed=SEED)
m.Fu2_sowndiv_p31 %>% pp_check(ndraws=100)

m.Fu2_sowndiv_p32 <- update(m.Fu2_sowndiv_p,
                            bf(Fu2 ~ sowndivLogStd*treatment + sowndivLogStd*week  + 
                                 (1|block/plot),
                               hu ~ 1 ),
                            seed=SEED)
m.Fu2_sowndiv_p32 %>% pp_check(ndraws=100)

m.Fu2_sowndiv_p4 <- update(m.Fu2_sowndiv_p,
                           bf(Fu2 ~ sowndivLogStd*treatment  + week + (1|block/plot),
                              hu ~ 1 ),
                           seed=SEED)
m.Fu2_sowndiv_p4 %>% pp_check(ndraws=100)

m.Fu2_sowndiv_p5 <- update(m.Fu2_sowndiv_p,
                           bf(Fu2 ~ sowndivLogStd*treatment + (1|block/plot),
                              hu ~ 1 ),
                           seed=SEED)
m.Fu2_sowndiv_p5 %>% pp_check(ndraws=100)
...
sum(dat$Fu3==0) #59 -> hu ~ sowndivLogStd*treatment + (1|block/plot)

m.Fu3_sowndiv_p <- brm(
  bf(Fu3 ~ sowndivLogStd*treatment*week + (1|block/plot),
...
m.Fu3_sowndiv_p2 <- update(m.Fu3_sowndiv_p,
                           bf(Fu3 ~ sowndivLogStd*treatment + sowndivLogStd*week + treatment*week + 
                              ...
                              hu ~ sowndivLogStd*treatment + (1|block/plot) ),
                           seed=SEED)
m.Fu3_sowndiv_p2 %>% pp_check(ndraws=100)

m.Fu3_sowndiv_p31 <- update(m.Fu3_sowndiv_p,
                            bf(Fu3 ~ sowndivLogStd*treatment + treatment*week + 
                                 (1|block/plot),
                               hu ~ 1 ),
                            seed=SEED)
m.Fu3_sowndiv_p31 %>% pp_check(ndraws=100)

m.Fu3_sowndiv_p32 <- update(m.Fu3_sowndiv_p,
                            bf(Fu3 ~ sowndivLogStd*treatment + sowndivLogStd*week  + 
                                 (1|block/plot),
                               hu ~ sowndivLogStd*treatment + (1|block/plot) ),
                            seed=SEED)
m.Fu3_sowndiv_p32 %>% pp_check(ndraws=100)

m.Fu3_sowndiv_p4 <- update(m.Fu3_sowndiv_p,
                           bf(Fu3 ~ sowndivLogStd*treatment  + week + (1|block/plot),
                              hu ~ sowndivLogStd*treatment + (1|block/plot) ),
                           seed=SEED)
m.Fu3_sowndiv_p4 %>% pp_check(ndraws=100)

m.Fu3_sowndiv_p5 <- update(m.Fu3_sowndiv_p,
                           bf(Fu3 ~ sowndivLogStd*treatment + (1|block/plot),
                              hu ~ sowndivLogStd*treatment + (1|block/plot) ),
                           seed=SEED)
m.Fu3_sowndiv_p5 %>% pp_check(ndraws=100)
...
sum(dat$Fu4==0) #68/228 -> hu ~ sowndivLogStd*treatment + (1|block/plot)

m.Fu4_sowndiv_p <- brm(
  bf(Fu4 ~ sowndivLogStd*treatment*week + (1|block/plot),
     hu ~ sowndivLogStd*treatment + (1|block/plot) ),
  data = dat, 
  prior = beta_coeff_priors,
  family = hurdle_lognormal,
...
m.Fu4_sowndiv_p2 <- update(m.Fu4_sowndiv_p,
                           bf(Fu4 ~ sowndivLogStd*treatment + sowndivLogStd*week + treatment*week + 
                              ...
                              hu ~ sowndivLogStd*treatment + (1|block/plot) ),
                           seed=SEED)
m.Fu4_sowndiv_p2 %>% pp_check(ndraws=100)

m.Fu4_sowndiv_p31 <- update(m.Fu4_sowndiv_p,
                            bf(Fu4 ~ sowndivLogStd*treatment + treatment*week + 
                                 (1|block/plot),
                               hu ~ sowndivLogStd*treatment + (1|block/plot) ),
                            seed=SEED)
m.Fu4_sowndiv_p31 %>% pp_check(ndraws=100)

m.Fu4_sowndiv_p32 <- update(m.Fu4_sowndiv_p,
                            bf(Fu4 ~ sowndivLogStd*treatment + sowndivLogStd*week  + 
                                 (1|block/plot),
                               hu ~ sowndivLogStd*treatment + (1|block/plot) ),
                            seed=SEED)
m.Fu4_sowndiv_p32 %>% pp_check(ndraws=100)

m.Fu4_sowndiv_p4 <- update(m.Fu4_sowndiv_p,
                           bf(Fu4 ~ sowndivLogStd*treatment  + week + (1|block/plot),
                              hu ~ sowndivLogStd*treatment + (1|block/plot) ),
                           seed=SEED)
m.Fu4_sowndiv_p4 %>% pp_check(ndraws=100)

m.Fu4_sowndiv_p5 <- update(m.Fu4_sowndiv_p,
                           bf(Fu4 ~ sowndivLogStd*treatment + (1|block/plot),
                              hu ~ sowndivLogStd*treatment + (1|block/plot) ),
                           seed=SEED)
m.Fu4_sowndiv_p5 %>% pp_check(ndraws=100)
